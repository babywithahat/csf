...
def test_unique_column_values():
    assert unique_column_values(poll_rows1, "ID") == set([ 1, 2, 3, 4, 5, 6 ])
    assert unique_column_values(poll_rows1, "State") == set([ "WA", "OR" ])
    assert unique_column_values(poll_rows1, "Pollster") == set([ "A", "B" ])
    assert unique_column_values(poll_rows1, "Date") == set([ "Jan 07 2010", "Jan 08 2010", "Feb 10 2010", "Mar 21 2010", "Mar 22 2010" ])
